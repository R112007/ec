package ec.world.blocks.storage;
...
public class ECUnloader extends Unloader {
  ...
  public class ECUnloaderBuild extends UnloaderBuild {
      ...
      for (int j = 0; j < processCount; j++) {
        ...
        if (item != null) {
          ...
          if (dumpingFrom != null && dumpingTo != null
            ...
            if (dumpingTo == null)
              Log.info("No valid dumpingTo found in ECUnloader");
            if (dumpingFrom == null)
              Log.info("No valid dumpingFrom found in ECUnloader");
    ...
    public void buildConfiguration(Table table) {
      ItemSelection.buildTable(ECUnloader.this, table, content.items(), () -> sortItem, this::configure, selectionRows,
          selectionColumns);
    }
